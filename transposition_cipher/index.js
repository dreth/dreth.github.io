...
function showGiftcardLinks() {
    if ($("#unlockContent").val() == "soup") {
        $("#giftCardLinks").html('<div class="centered"><a class="b" href="https://www.mooments.com/sg/giftcards/accept/c33949868bb1d4a771481ff34b2e1a9a">Gift 1</a>&emsp;&emsp;<a class="b" href="https://www.mooments.com/sg/giftcards/accept/d713d6a898375bd79c791d399a585288">Gift 2</a></div>')
    }
